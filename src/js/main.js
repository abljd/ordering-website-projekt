...
document.addEventListener('DOMContentLoaded', () => {
	...
	categories.forEach(category => {
		category.addEventListener('click', () => {
			...
			const selectedItems = document.querySelectorAll(`.item[data-category="${selectedCategory}"]`)
	...
	const initialCategory = document.querySelector('.category[data-category="pizza"]')
	initialCategory.click()

	// Add animation class to items in the initial category after page load
	const initialItems = document.querySelectorAll('.item[data-category="pizza"]')
